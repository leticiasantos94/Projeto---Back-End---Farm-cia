package com.drogaria.farmasantos.controller;
...
import com.drogaria.farmasantos.repository.CategoriasRepository;
import com.drogaria.farmasantos.repository.ProdutosRepository;
...
public class ProdutosController {
	...
	public ResponseEntity<Produtos> post(@Valid @RequestBody Produtos produtos){
		if(categoriasRepository.existsById(produtos.getCategoria().getId()))
